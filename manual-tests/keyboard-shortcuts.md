...
### TC - Search attachments with cmd+f
Steps: 
...
### TC - Open File with Cmd+o
Steps:
- Select an attachment
- Press cmd+e
- Verify all fields are now editable
- Verify name field is focused automatically
- Press cmd+s (or cmd+e again)
- Verify it goes back to normal

### TC - Edit and Save with Cmd+e/s
Stetps:
- Select an attachment
- Press cmd+e
- Verify all fields are now editable
...
### TC - Edit, tab skips buttons
Steps:
- Select an attachment
- Go to 'edit' mode
- Name should be focused
- Press "tab"
- Verify focus goes to date element, not "Edit" (which is techncially the next elemenet)